...
export function HeaderNav() {
	...
	return (
		<nav className="3xl:max-w-[1054px] 3xl:text-[14px] 3xl:gap-[40px] hidden max-w-[600px] grow items-center justify-start gap-[20px] text-[12px] text-white xl:max-w-[680px] 2xl:flex 2xl:max-w-[800px]">
			{headerNav.map((item) => {
