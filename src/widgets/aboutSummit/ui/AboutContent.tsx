		...
		<>
			<section className="bg-white pt-[100px]">
				<Container className="relative z-10 flex items-start justify-between">
					<div
						ref={TextRef}
						className="text-text max-w-[721px] translate-y-[50px] text-[16px] leading-normal font-normal whitespace-pre-line opacity-0"
					>
				...
				<Container className="relative z-10 flex items-start justify-between gap-[58px]">
					...
					<div className="w-full max-w-[859px] grow">
						...
						<p
							...
							className="mb-[60px] translate-y-[50px] opacity-0"
						>
						...
						<p
							ref={Text2Ref}
							className="text-text translate-y-[50px] text-[16px] leading-normal font-normal whitespace-pre-line opacity-0"
						>
			...
			<section className="bg-white pt-[68px]">
				<Container className="relative z-10 flex items-stretch justify-between gap-[58px]">
					...
					>
						<div className="relative z-10 max-w-[456px]">
							<p
								...
								className="font-regular mb-[55px] translate-y-[50px] text-left text-[24px] leading-[1.3] text-white opacity-0"
							>
						...
						<div
							...
							className="absolute right-0 bottom-0 translate-x-[-200px] opacity-0"
						>
							<Image
					...
					<div
						ref={QuoteRef}
						className="seld-start relative w-full max-w-[859px] translate-y-[50px] rounded-[12px] bg-[#FBFFE9] p-[20px] pr-[26px] opacity-0 md:pt-[65px] md:pl-[86px]"
					>
						...
						<div
							...
							className="relative z-1 flex flex-wrap items-center gap-[30px] sm:flex-nowrap"
						>
							<Image
