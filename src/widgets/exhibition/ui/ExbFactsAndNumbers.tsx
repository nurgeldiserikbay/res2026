		...
		<section className="bg-white pt-[50px] md:pt-[60px] lg:pt-[80px] 2xl:pt-[100px]">
			<Container>
				<div className="rounded-[12px] bg-[#02493F] bg-[url('/imgs/usefulls/facts-and-numbers-bg.png')] bg-cover bg-center bg-no-repeat p-[20px] py-[57px] lg:px-[55px] lg:pt-[60px] lg:pb-[55px]">
					<h2 className="3xl:text-[48px] mx-auto mb-[15px] max-w-[302px] text-center text-[32px] leading-[1.2] font-bold text-white sm:max-w-none lg:text-left xl:text-[36px] 2xl:text-[30px]">
