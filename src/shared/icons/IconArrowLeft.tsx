...
export function IconArrowLeft({ size = 24, color, title = 'Arrow left', className, ...props }: IconProps) {
	...
	return (
		...
		>
			...
			/>
			<path
				d="M18.9999 18.2499C18.8099 18.2499 18.6199 18.1799 18.4699 18.0299L4.46994 4.02994C4.17994 3.73994 4.17994 3.25994 4.46994 2.96994C4.75994 2.67994 5.23994 2.67994 5.52994 2.96994L19.5299 16.9699C19.8199 17.2599 19.8199 17.7399 19.5299 18.0299C19.3799 18.1799 19.1899 18.2499 18.9999 18.2499Z"
				fill={fill}
			/>
			<path
