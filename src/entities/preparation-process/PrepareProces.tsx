	...
	return (
		<div className="flex w-full flex-wrap items-start justify-between gap-x-[30px] gap-y-[60px] rounded-[12px] bg-[#F4FFF7] p-[26px] lg:flex-nowrap">
			<div className="lg:w-[50%]">
				...
				<div className="text-text mb-[30px] text-[20px] leading-normal font-normal lg:text-[22px] 2xl:text-[24px]">{subtitle}</div>
				<div className="text-text text-[16px] leading-normal font-normal">{description}</div>
				{link && (
					<Link
						href={link.src}
						target="_blank"
			...
			<div className="grow overflow-hidden rounded-[12px] lg:max-w-[480px] lg:shrink-0 xl:max-w-[600px] 2xl:max-w-[909px]">
				{images?.length > 0 && (
					<ImageSlider
						images={images}
						alt={title}
