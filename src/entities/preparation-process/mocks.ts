		...
		items: [
			{
				...
				description: {
					...
					en: 'The Second Regional Consultation focused on strengthening regional environmental cooperation. It was conducted in a high-level dialogue format with the participation of Ministers responsible for environmental issues from Central Asian countries, heads of regional UN agencies, and international financial institutions. The outcomes included a proposal to establish a pipeline of regional projects and to designate national focal points from each country to ensure effective coordination in the preparation for RES 2026.',
				},
		...
		items: [
			{
				...
				description: {
					...
					en: 'The Third Regional Consultation was held with the participation of heads of environmental authorities of Central Asian countries and representatives of UN agencies, non-governmental organizations, and other stakeholders. Within the framework of the consultation, the Potsdam Institute for Climate Impact Research (PIK) presented the concept of the Kazakhstan Country Climate Risk Profile as one of the Summit outcomes. The consultation enabled discussion of the most acute climate risks in the region and approaches to mechanisms for responding to such risks.',
				},
				images: [
		...
		items: [
			{
				...
				description: {
					...
					en: 'A meeting of Ministers responsible for environmental issues of Central Asian countries was held, resulting in the adoption of a Protocol. In accordance with the Protocol, the Parties approved the key thematic areas of RES 2026 and the concept of the green technologies exhibition, and agreed to continue work on the draft Declaration of the Heads of State of Central Asia to be adopted at the Summit. A preliminary pool of regional initiatives was also reviewed.',
				},
				images: [
		...
		items: [
			{
				...
				description: {
					ru: 'В брифинге по подготовке к РЭС 2026 приняли участие Постоянный представитель Республики Казахстан при ООН, Министр экологии и природных ресурсов Республики Казахстан, Президент СОР29, Исполнительный секретарь ЕЭК ООН, представители стран Центральной Азии, UNEP, ПРООН, ООН-женщины, ЮНФПА, и др. \n Презентован проект Программы действий по реализации региональных экологических инициатив при партнерстве с ООН на 2026-2030 годы. Программа включает ключевые региональные инициативы по формированию концепции инвестиционного портфеля по климату и экологии, по природоориентированным решениям, запуску регионального обзора результативности экологической деятельности, циркулярной экономике и др. \n По итогам брифинга выражена поддержка Программы действий со стороны агентств ООН.',
					...
					en: 'A briefing on preparations for RES 2026 was attended by the Permanent Representative of the Republic of Kazakhstan to the UN, the Minister of Ecology and Natural Resources of the Republic of Kazakhstan, the President of COP29, the Executive Secretary of the UNECE, representatives of Central Asian countries, UNEP, UNDP, UN Women, UNFPA, and others. \n The draft Programme of Action for the implementation of regional environmental initiatives in partnership with the UN for 2026-2030 was presented. The Programme includes key regional initiatives aimed at developing a climate and ecology investment portfolio concept, nature-based solutions, the launch of a regional environmental performance review, circular economy initiatives, and others. \n Following the briefing, UN agencies expressed their support for the Programme of Action.',
				},
				images: [
		...
		items: [
			{
				...
				description: {
					ru: 'На официальном сайд-ивенте на тему «Высыхание морей и озер - глобальная катастрофа XXI века» приняли участие руководители экологических ведомств различных стран, включая Францию и Нигерию, первые руководители ЮНЕП, ЕЭК ООН, Секретариата Рамсарской конвенции, Международного фонда спасения Арала, представители финансовых институтов, научно-исследовательских центров и экспертного сообщества. \n В рамках мероприятия была презентована работа по восстановлению Северного Арала, со стороны ЕЭК ООН и ЮНЕП выражена поддержка инициативы проведения РЭС 2026 в Астане. \n В ходе сайд-ивента состоялась премьера видеоролика Секретариата КБО ООН “Шепот Аральского моря”, в котором представлены актуальные проблемы населения, проживающего в регионе Приаралья. По итогам сайд-ивента Казахстан выступил с предложением по разработке резолюции по преодолению водного кризиса на ЮНЕА-8.',
					...
					en: 'At the official side event entitled “Drying Seas and Lakes: A Global Catastrophe of the 21st Century”, participants included heads of environmental authorities from various countries, including France and Nigeria, senior leadership of UNEP, UNECE, the Ramsar Convention Secretariat, the International Fund for Saving the Aral Sea, representatives of financial institutions, research centers, and the expert community. \n During the event, restoration efforts of the North Aral Sea were presented, and UNECE and UNEP expressed support for the initiative to hold RES 2026 in Astana. The side event also featured the premiere of the UNCCD Secretariat’s video “The Whisper of the Aral Sea”, highlighting the pressing challenges faced by communities in the Aral Sea region. Following the event, Kazakhstan proposed the development of a resolution on addressing the water crisis at UNEA-8.',
				},
				images: [
