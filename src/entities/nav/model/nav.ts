...
export const navItems: readonly NavItem[] = [
	...
	},
	{
		...
		ready: true,
		children: [
			{ key: 'useful.astana', href: '/useful/astana', ready: true, showHeader: true, showFooter: true },
			{ key: 'useful.venue', href: '/useful/venue', ready: true, showHeader: true, showFooter: true },
			{ key: 'useful.hotels', href: '/useful/hotels', ready: true, showHeader: true, showFooter: true },
			{ key: 'useful.restaurants', href: '/useful/restaurants', ready: true, showHeader: true, showFooter: true },
			{ key: 'useful.visa', href: '/useful/visa', ready: !appConfig.isProduction, showHeader: !appConfig.isProduction, showFooter: true },
